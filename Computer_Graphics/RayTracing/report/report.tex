...
\begin{figure}
  \centering
  \subfloat[Рендеринг в пакете]{\label{fig:diamond-brt}\includegraphics[height=5cm]{./screenshots/diamond_brt.png}}
  \quad
  \subfloat[Рендеринг в \textit{Blender}]{\label{fig:diamond-blender}\includegraphics[height=5cm]{./screenshots/diamond_blender.png}}
  \caption{Рендеринг тестовой сцены}
  \label{fig:prism-test-results}
\end{figure}
